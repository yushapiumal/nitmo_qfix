...
class TabletUpdate extends StatefulWidget {
  TabletUpdate({Key? key, this.taskData,  this. markUpdateTask}) : super(key: key);
  int? id;
  final  markUpdateTask;
  final taskData;
  @override
  State<TabletUpdate> createState() => _TabletUpdateState();
}

class _TabletUpdateState extends State<TabletUpdate> {
  ...
  List<Color> colors = List.generate(6, (index) => Colors.amber);
  List reasons = [
    " Lack of resources",
    "Time constraints",
    "Technical issues",
          ...
          onPressed: () async {
            setState(() {
              if (_selectedIndex != null) {
                colors[_selectedIndex!] = Colors.amber; 
              }
